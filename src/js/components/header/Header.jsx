                ...
                <div className="header__wrap container">
                    ...
                    <nav className="header__nav">
                        ...
                        <div className="icserch">
                            <span className="iconbox" onClick={() => navigate('/search')}>
                        ...
                        <div className="menuzz">
                            ...
                            >
                                {user?.email ? (
                                    <>
                                        <MenuItem onClick={() => navigate('/z/movie')}>
                                            <div className="loggz"><i className='bx bxs-camera-movie'></i> Movies</div>
                                        </MenuItem>
                                        <MenuItem onClick={() => navigate('/z/tv')}>
                                            <div className="loggz"><i className='bx bxs-tv'></i> Shows</div>
                                        </MenuItem>
