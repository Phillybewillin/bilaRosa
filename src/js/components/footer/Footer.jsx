                ...
                <div className="footer__content__logo">
                   <div className="logo">
                       <Link to="/">Made by some guy</Link>
                        <i className="bx bxs-heart" style={{color: 'white', fontSize: '16px' ,paddingLeft: "7px"}}></i>
                    </div>
                    <div className="acca">
                    <a href="https://www.buymeacoffee.com/zillaxr.xyz" target="_blank" rel="noreferrer"><i className="bx bx bxs-coffee" style={{color: 'pink', fontSize: '25px' ,backgroundColor:"black", padding:"5px" ,borderRadius:"5px"}}></i></a>
