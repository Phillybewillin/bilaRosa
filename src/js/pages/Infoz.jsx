...
const info = () => {
    return <div className="infoz" style={{display : 'flex', flexDirection : 'column', justifyContent : 'center', alignItems : 'center', gap : '1rem',padding : '1rem',margin : '2rem',backgroundColor : 'white',borderRadius : '10px',color : 'black',width: '90vw',fontSize:"12px"}}>
        ...
        <ul>
            <li><strong>Unmatched Selection:</strong> Explore a diverse range of XR experiences, including games(coming soon) , movies, shows and more.</li>
        ...
        <p>Zilla-XR is accessible through various XR devices like VR headsets, AR glasses, and even your mobile phone (with compatible apps). We provide detailed instructions and compatibility information for each experience on the platform.</p>
