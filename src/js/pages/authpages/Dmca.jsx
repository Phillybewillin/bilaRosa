...
const DMCATakedownRequest = () => {
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' , paddingTop: ' 100px' , textAlign: 'left',fontSize: '12px' }}>
      <h2>DMCA Takedown Request Requirements</h2>
      <p>
        We take the intellectual property rights of others seriously and require that our Users do the same. The Digital Millennium Copyright Act (DMCA) established a process for addressing claims of copyright infringement. If you own a copyright or have authority to act on behalf of a copyright owner and want to report a claim that a third party is infringing that material on or through Zilla-XR's services, please submit a DMCA report to us, and we will take appropriate action.
      </p>
      <h3>DMCA Report Requirements</h3>
      <ul>
        <li>
...
export default DMCATakedownRequest;
